...
public class RobotContainer {
  ...
  .onTrue(new TurnToAngle(180, m_drivetrain));

  new JoystickButton(m_controller, 1)
  .onTrue(new TurnToAngle(0, m_drivetrain));

      
    // Setup SmartDashboard options
    m_chooser.setDefaultOption("Auto Routine Distance", 
    new AutonomousDistance(m_drivetrain));
    m_chooser.addOption("TurnToAngle90", 
